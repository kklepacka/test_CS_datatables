...
Test semi colon
    ...
    Given testing ; echo toto "${datatables}[datatable_1]"
...
Test Setup
    ...
    ...                You can define the ${TEST_218_SETUP} variable with a keyword for setting up this specific test.
    ...                If both are defined, ${TEST_218_SETUP} will be run after ${TEST_SETUP}.

    ${TEST_SETUP_VALUE} =        Get Variable Value    ${TEST_SETUP}
    ${TEST_218_SETUP_VALUE} =    Get Variable Value    ${TEST_218_SETUP}
    IF    $TEST_SETUP_VALUE is not None        Run Keyword    ${TEST_SETUP}
    IF    $TEST_218_SETUP_VALUE is not None    Run Keyword    ${TEST_218_SETUP}

Test Teardown
    [Documentation]    test teardown
    ...                You can define the ${TEST_TEARDOWN} variable with a keyword for tearing down all your tests.
    ...                You can define the ${TEST_218_TEARDOWN} variable with a keyword for tearing down this specific test.
    ...                If both are defined, ${TEST_TEARDOWN} will be run after ${TEST_218_TEARDOWN}.

    ${TEST_218_TEARDOWN_VALUE} =    Get Variable Value    ${TEST_218_TEARDOWN}
    ${TEST_TEARDOWN_VALUE} =        Get Variable Value    ${TEST_TEARDOWN}
    IF    $TEST_218_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_218_TEARDOWN}
...
Retrieve Datatables
    ...
    @{row_1_2} =    Create List    ; echo toto    ; echo toto
    @{datatable_1} =    Create List    ${row_1_1}    ${row_1_2}
