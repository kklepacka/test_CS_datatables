...
Test chaine speciale
    ...
    Given testing +-_.~@€çé=àûığ "${datatables}[datatable_1]"
...
Test Setup
    ...
    IF    $TEST_236_SETUP_VALUE is not None    Run Keyword    ${TEST_236_SETUP}
...
Test Teardown
    ...
    IF    $TEST_236_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_236_TEARDOWN}
...
Retrieve Datatables
    ...
    @{row_1_2} =    Create List    +-_.~\@€çé\=àûığ    +-_.~\@€çé\=àûığ
    @{datatable_1} =    Create List    ${row_1_1}    ${row_1_2}
